 ...
 */
package com.iyestin.demo.cas.spring.servlet;
...
public final class ProxyTicketSampleServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		super.init();
		String casServiceHost = System.getProperty("cas.service.host", "localhost:8080");
		targetUrl = "http://" + casServiceHost + "/cas-sample/secure/";
	}
